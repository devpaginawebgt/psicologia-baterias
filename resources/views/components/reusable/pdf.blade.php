<div class="flex items-center justify-between bg-zinc-800 hover:bg-zinc-700 rounded-sm">
    <a
        class="w-full flex items-center gap-3 text-sm text-gray-300 py-3 px-3"
        href="/materiales/{{ $filename }}"
        target="_blank"
    >
    ...
    <div class="flex items-center gap-2 py-3 pe-3">
        <x-mary-button
            link="/descargar-material/{{ $filename }}"
            class="btn-sm btn-soft"
            no-wire-navigate
        >
            <x-mary-icon name="o-arrow-down-tray" class="w-4" />
        </x-mary-button>

        {{-- <x-mary-button
            link="/materiales/{{ $filename }}"
            target="_blank"
            class="btn-sm btn-soft"
            no-wire-navigate
        >
            <x-mary-icon name="o-arrow-top-right-on-square" class="w-4" />
        </x-mary-button> --}}
    </div>
</div>
