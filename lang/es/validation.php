...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'form.division_id'        => 'departamento',
        'form.marital_status'     => 'estado civil',
        'form.children'           => 'número de hijos',
        'form.people_depending'   => 'Personas que dependen de mí',
        'form.diseases'           => 'enfermedad crónica',
        'form.diseases.*'         => 'enfermedad crónica',
        'form.transportation'     => 'se traslada a su trabajo en',
        'form.hiring_date'        => 'fecha de ingreso a la empresa',
        'form.shift'              => 'turno de trabajo',
        'form.branch_number'      => 'No. de sucursal',
        'form.branch_address'     => 'dirección de sucursal',
        'form.position'           => 'cargo',
        'form.sales_productivity' => 'productividad',
    ],
