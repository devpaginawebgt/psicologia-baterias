...
class EmployeeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'form.branch_subdivision_id.required' => 'Seleccione el municipio de la Sucursal',
            'form.branch_subdivision_id.integer'  => 'Seleccione el municipio de la Sucursal',
            'form.branch_subdivision_id.exists'   => 'Seleccione el municipio de la Sucursal',
        ];
    }
}
